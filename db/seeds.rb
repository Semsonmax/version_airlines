...
z1 = Zeppelin.create(name: 'The Lord Grantham', style: 'Victoria Class', number_of_rows: 7, number_of_columns: 4, description: 'Our flagship vessel, it has not exploded in over 34 years of service', engines: '4 diesel', image: 'zep1.jpg', year_built: 1911)
...
z4 = Zeppelin.create(name: 'HMS Buttercup', style: 'Victoria Class', number_of_rows: 5, number_of_columns: 3, description: 'Crowned as 1914s Zep-o-the-year, this beauty can make a transatlantic voyage in just a mere 3 weeks', engines: '2 diesel', image: 'zep4.jpg', year_built: 1914)
