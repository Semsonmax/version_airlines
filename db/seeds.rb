...
z1 = Zeppelin.create(name: 'The Lord Grantham', style: 'Victoria Class', number_of_rows: 3, number_of_columns: 7, description: 'Our flagship vessel, it has not exploded in over 34 years of service', engines: '4 diesel', image: 'zep1.jpg', year_built: 1911)
