...
z1 = Zeppelin.create(name: 'The Lord Grantham', style: 'Victoria Class', number_of_rows: 20, number_of_columns: 9)
z2 = Zeppelin.create(name: 'The Admiral Nelson', style: 'Wellington Class', number_of_rows: 10, number_of_columns: 6)
z3 = Zeppelin.create(name: 'The Royal Ulsterman', style: 'Clipper Class', number_of_rows: 15, number_of_columns: 4)
z4 = Zeppelin.create(name: 'HMS Buttercup', style: 'Victoria Class', number_of_rows: 20, number_of_columns: 9)
